...
function Note(props) {
  return (
    <div className={`${props.complete === true ? 'bg-green-300' : 'bg-slate-300'} flex flex-col items-center justify-center w-1/2 m-1 rounded-lg 
    border-solid border-2 border-slate-950 drop-shadow-xl`}>
